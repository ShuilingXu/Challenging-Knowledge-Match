...
export const api = {
  ...
  questionSets: (id) => request(`/api/activities/${id}/question-sets`),
  createQuestionSet: (id, payload) => request(`/api/activities/${id}/question-sets`, { method: 'POST', body: payload }),
  ...
  updateUser: (userId, payload) => request(`/api/admin/users/${userId}`, { method: 'PATCH', body: payload }),
  ...
  membershipUsers: (id) => request(`/api/activities/${id}/memberships/users`),
  updateMembershipUser: (id, userId, payload) => request(`/api/activities/${id}/memberships/users/${userId}`, { method: 'PATCH', body: payload }),
